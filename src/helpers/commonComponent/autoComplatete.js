...
import { IsAlphabetOrNumber, TransformData } from "../functionHelper";
// import {
//   selectBookListState,
//   setFilterObject,
//   setSearchString,
// } from "app/store/BookSlice/bookList";
...
export default function AutoComplatete() {
  ...
  const onHandleKey = (e) => {
    // const isAlphabetOrNumber = IsAlphabetOrNumber(e.key);
    if (e.key === "Enter") {
      //   dispatch(setSearchString(`isSearch_${e.target.value}`.trim()));
  ...
  React.useEffect(() => {
    ...
    setBookData(TransformData(bookList));
  }, [BookListState]);
